...
OPTIMIZE TABLE prefix_User

;


OPTIMIZE TABLE prefix_Addon

;


OPTIMIZE TABLE prefix_AdminEntry

;

OPTIMIZE TABLE prefix_Article

;

OPTIMIZE TABLE prefix_BadWord

;

OPTIMIZE TABLE prefix_Bookmark

;

OPTIMIZE TABLE prefix_Category

;

OPTIMIZE TABLE prefix_Code

;

OPTIMIZE TABLE prefix_Download

;

OPTIMIZE TABLE prefix_File

;

OPTIMIZE TABLE prefix_Forum

;

OPTIMIZE TABLE prefix_ForumType

;

OPTIMIZE TABLE prefix_Language

;

OPTIMIZE TABLE prefix_LastVisit

;

OPTIMIZE TABLE prefix_Log

;

OPTIMIZE TABLE prefix_PersonalMessage

;

OPTIMIZE TABLE prefix_Poll

;

OPTIMIZE TABLE prefix_PollVariant

;

OPTIMIZE TABLE prefix_Post

;

OPTIMIZE TABLE prefix_Smile

;

OPTIMIZE TABLE prefix_StyleSet

;

OPTIMIZE TABLE prefix_Subscription

;

OPTIMIZE TABLE prefix_Topic

;

OPTIMIZE TABLE prefix_TopicRate

;

OPTIMIZE TABLE prefix_TopicView

;

OPTIMIZE TABLE prefix_UGroup

;

OPTIMIZE TABLE prefix_UGroupAccess

;

OPTIMIZE TABLE prefix_UGroupMember
...
OPTIMIZE TABLE prefix_UserAccess

;

OPTIMIZE TABLE prefix_UserLevel

;

OPTIMIZE TABLE prefix_UserRating

;

OPTIMIZE TABLE prefix_UserWarning

;

OPTIMIZE TABLE prefix_Vote

;

UPDATE prefix_Language SET ln_locale="ru_RU.ISO-8859-5" WHERE ln_locale="ru_RU"

...
ADD INDEX P_tidkey(p_tid, p__premoderate), DROP INDEX P_premodkey, DROP INDEX premod, DROP INDEX posts;


ALTER TABLE prefix_User ADD COLUMN u_extform TINYINT NOT NULL DEFAULT 1;

ALTER TABLE prefix_User ADD COLUMN u_aperpage SMALLINT NOT NULL DEFAULT 10;

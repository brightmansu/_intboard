...
<? }
else { ?><img src="styles/<?=$GLOBALS['inuser']['st_file'];?>/logo.gif" border=0 alt="<?=htmlspecialchars($GLOBALS['opt_title']." - ".$GLOBALS['opt_descr']);?>"><? }
...
?><table class="announce" width="100%" cellspacing=1 align=center><tr><td class="tablehead">
<?=MSG_announce;?>
<tr><td><br>
...
<? } ?>
<span class="maintext"><a href="index.php?m=misc&amp;a=view_rules"><?=MSG_forum_rules;?></a></span>

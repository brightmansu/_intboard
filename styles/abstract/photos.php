<?
function photos_params($catselect,$levelselect,$fdata,$fcontainer,$langselect) { ?>
...
function photo_list_start($pages,$rows) {
...
function photo_list_entry(&$phdata) { ?>
...
function photo_list_end($pages,$inforum,$autosub) { ?>
...
function photo_display(&$tdata,&$phdata,&$pdata,$rated,$thumbs,$curpos) {
?>
...
function photo_edit_form(&$tdata,&$pdata,$newaction,$msg) {
...
function photo_print_form(&$tdata,&$phdata,&$pdata) { ?>
<H3><?=MSG_t_print;?></H3>
